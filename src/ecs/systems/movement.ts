...
import { CONTROL, MOTION, ORIENTATION, PLAYER, POSITION, type ControlC, type MotionC } from "../components/Player";
import { canControl, INPUT_STATE, UI_MODAL, type InputState, type UiModalState } from "../resources";
